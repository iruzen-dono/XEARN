...
const features = [
  {
    icon: Smartphone,
    title: 'Accessible',
    desc: 'Un smartphone et une connexion Internet suffisent pour commencer à gagner.',
  },
  {
    icon: Wallet,
    title: 'Retraits rapides',
    desc: 'Retirez vos gains via MTN, Flooz, TMoney ou Orange Money.',
  },
  {
    icon: Users,
    title: 'Parrainage 2 niveaux',
    desc: '40 % niveau 1, 10 % niveau 2. Gagnez sur votre réseau.',
  },
  {
    icon: TrendingUp,
    title: 'Revenus croissants',
    desc: 'Plus vous êtes actif, plus vous gagnez de récompenses.',
  },
  {
    icon: Shield,
    title: 'Sécurisé',
    desc: 'Anti-triche avancé, détection multi-comptes, données protégées.',
  },
  {
    icon: Zap,
    title: 'Instantané',
    desc: 'Validation automatique des tâches et crédits immédiats sur votre wallet.',
  },
];
...
const steps = [
  ...
  },
  {
    step: '02',
    title: 'Activez',
    desc: "Payez 4 000 FCFA pour débloquer les retraits et l'affiliation.",
  },
  {
    step: '03',
    title: 'Complétez',
    desc: "Regardez des publicités et gagnez de l'argent automatiquement.",
  },
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <MotionDiv preset="fadeUp" delay={0.1}>
            <h1 className="heading-xl mb-6 text-balance">
              Gagnez de l&apos;argent <span className="gradient-text">simplement</span>
          ...
          <MotionDiv preset="fadeUp" delay={0.2}>
            <p className="text-lg sm:text-xl text-dark-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              Regardez des publicités, complétez des tâches et parrainez vos proches pour générer
              des revenus en ligne. Accessible à tous.
            </p>
          </MotionDiv>
      ...
      <section id="pricing" className="section px-4">
        <div className="max-w-6xl mx-auto">
          <MotionDiv preset="fadeUp" className="section-header">
            ...
            <h2 className="heading-lg mb-4">
              <span className="gradient-text">4 niveaux</span> pour maximiser vos revenus
            </h2>
            <p className="text-dark-400 text-center max-w-2xl mx-auto">
              Commencez gratuitement, puis choisissez le niveau qui vous convient pour débloquer
              plus d&apos;avantages.
            </p>
          </MotionDiv>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <MotionDiv preset="fadeUp" delay={0.1}>
              <div className="card-hover h-full flex flex-col">
                ...
                <p className="text-dark-400 text-xs mb-4">Découverte</p>
                <div className="text-3xl font-extrabold mb-5">
                  0 <span className="text-base font-normal text-dark-400">FCFA</span>
                </div>
                <ul className="space-y-2.5 mb-6 flex-1 text-sm">
                  {['Accès aux tâches publicitaires', 'Consultation du wallet'].map((t) => (
                    <li key={t} className="flex items-start gap-2 text-dark-300">
                      <CheckCircle className="w-4 h-4 text-dark-500 mt-0.5 flex-shrink-0" />
                      {t}
                    </li>
                  ))}
                  {['Retraits', 'Parrainage', 'Tâches premium'].map((t) => (
                    <li key={t} className="flex items-start gap-2 text-dark-500 line-through">
                      <CheckCircle className="w-4 h-4 text-dark-600 mt-0.5 flex-shrink-0" />
                      {t}
                    </li>
                  ))}
                </ul>
                <Link href="/register" className="btn-secondary w-full text-center text-sm">
                  Commencer
                </Link>
              </div>
            </MotionDiv>
            ...
            <MotionDiv preset="fadeUp" delay={0.2}>
              <div className="card-hover h-full flex flex-col">
                <h3 className="text-lg font-bold mb-1">Activé</h3>
                <p className="text-dark-400 text-xs mb-4">Standard</p>
                <div className="text-3xl font-extrabold mb-1">
                  4 000 <span className="text-base font-normal text-dark-400">FCFA</span>
                </div>
                <p className="text-dark-500 text-xs mb-5">Paiement unique</p>
                <ul className="space-y-2.5 mb-6 flex-1 text-sm">
                  {[
                    'Tâches standard',
                    'Retraits (frais 10 %)',
                  ...
                  {['Tâches premium / VIP', 'Commission L2 / L3'].map((t) => (
                    <li key={t} className="flex items-start gap-2 text-dark-500 line-through">
                      <CheckCircle className="w-4 h-4 text-dark-600 mt-0.5 flex-shrink-0" />
                      {t}
                    </li>
            ...
            <MotionDiv preset="fadeUp" delay={0.3}>
              <div className="relative card-hover h-full flex flex-col gradient-border overflow-visible">
                ...
                <h3 className="text-lg font-bold mb-1 text-purple-400">Premium</h3>
                <p className="text-dark-400 text-xs mb-4">Revenus boostés</p>
                <div className="text-3xl font-extrabold mb-1">
                  10 000 <span className="text-base font-normal text-dark-400">FCFA</span>
                </div>
                <p className="text-dark-500 text-xs mb-5">Paiement unique</p>
                <ul className="space-y-2.5 mb-6 flex-1 text-sm">
                  {[
                    'Tâches standard + premium',
                    'Retraits (frais 5 %)',
                    'Parrainage L1 (40 %)',
                    'Parrainage L2 (10 %)',
                    'Support prioritaire',
                  ].map((t) => (
                    <li key={t} className="flex items-start gap-2 text-dark-200">
                      <CheckCircle className="w-4 h-4 text-primary-400 mt-0.5 flex-shrink-0" />
                      {t}
                    </li>
                  ))}
                  {['Tâches VIP', 'Commission L3'].map((t) => (
                    <li key={t} className="flex items-start gap-2 text-dark-500 line-through">
                      <CheckCircle className="w-4 h-4 text-dark-600 mt-0.5 flex-shrink-0" />
                      {t}
                    </li>
                ...
                <Link href="/register" className="btn-primary w-full text-center text-sm group">
                  Choisir Premium
            ...
            {/* VIP */}
            <MotionDiv preset="fadeUp" delay={0.4}>
              <div className="card-hover h-full flex flex-col border-amber-500/20">
                <h3 className="text-lg font-bold mb-1 text-amber-400">VIP</h3>
                <p className="text-dark-400 text-xs mb-4">Revenus maximaux</p>
                <div className="text-3xl font-extrabold mb-1">
                  25 000 <span className="text-base font-normal text-dark-400">FCFA</span>
                </div>
                <p className="text-dark-500 text-xs mb-5">Paiement unique</p>
                <ul className="space-y-2.5 mb-6 flex-1 text-sm">
                  {[
                    'Toutes les tâches (VIP incluses)',
                    'Retraits (frais 2 % seulement)',
                    'Parrainage L1 (40 %)',
                    'Parrainage L2 (10 %)',
                    'Parrainage L3 (5 %)',
                    'Support VIP dédié',
                ...
                <Link
                  href="/register"
                  className="w-full text-center text-sm inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-semibold bg-gradient-to-r from-yellow-500/20 to-amber-500/20 text-amber-400 border border-amber-500/30 hover:from-yellow-500/30 hover:to-amber-500/30 transition-all"
                >
                  Devenir VIP
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 text-center md:text-left">
            <p className="text-dark-500 text-xs">
              © {new Date().getFullYear()} XEARN. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
