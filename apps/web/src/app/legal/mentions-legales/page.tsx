      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="space-y-10 text-dark-300 leading-relaxed">
          <section>
            ...
            <p>
              Le site <strong className="text-white">XEARN</strong> (ci-après « le Site ») est édité
              par :
            </p>
            <ul className="mt-4 space-y-2 list-none">
              <li>
                <strong className="text-dark-200">Raison sociale :</strong> XEARN
              </li>
              <li>
                <strong className="text-dark-200">Responsable de la publication :</strong> Jules
                Zhou
              </li>
              <li>
                <strong className="text-dark-200">Adresse e-mail :</strong> contact@xearn.com
              </li>
              <li>
                <strong className="text-dark-200">Statut :</strong> Entrepreneur individuel
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-none">
              <li>
                <strong className="text-dark-200">Hébergeur frontend :</strong> Vercel Inc.
              </li>
              <li>
                <strong className="text-dark-200">Adresse :</strong> 340 S Lemon Ave #4133, Walnut,
                CA 91789, États-Unis
              </li>
              <li>
                <strong className="text-dark-200">Site web :</strong> https://vercel.com
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              L&apos;ensemble des éléments du Site (textes, images, logos, icônes, logiciels, base
              de données, structure) est protégé par les lois en vigueur relatives à la propriété
              intellectuelle.
            </p>
            <p className="mt-4">
              ...
              ce soit, sans l&apos;autorisation expresse et préalable de XEARN est interdite et
          ...
          <section>
            ...
            <p>
              XEARN s&apos;efforce d&apos;assurer l&apos;exactitude des informations diffusées sur
              le Site. Toutefois, XEARN ne peut garantir l&apos;exactitude, la complétude et
              l&apos;actualité des informations publiées.
            </p>
            <p className="mt-4">
              XEARN décline toute responsabilité en cas d&apos;interruption du Site, de survenance
              de bugs, d&apos;inexactitude des informations ou de tout dommage résultant d&apos;une
              intrusion frauduleuse d&apos;un tiers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Le Site peut contenir des liens vers d&apos;autres sites internet. XEARN n&apos;exerce
              aucun contrôle sur ces sites et n&apos;assume aucune responsabilité quant à leur
              contenu.
            </p>
          </section>
