        ...
        <div className="space-y-10 text-dark-300 leading-relaxed">
          <section>
            ...
            <p>
              ...
              personnelles que nous collectons, comment nous les utilisons et les droits dont vous
              disposez.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-dark-200 mt-6 mb-3">
              2.1 Données fournies directement
            </h3>
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">Identité :</strong> nom, prénom
              </li>
              <li>
                <strong className="text-dark-200">Contact :</strong> adresse e-mail
              </li>
              <li>
                <strong className="text-dark-200">Authentification :</strong> mot de passe (stocké
                de manière chiffrée), identifiant Google (si connexion via Google)
              </li>
              <li>
                <strong className="text-dark-200">Paiement :</strong> informations nécessaires au
                traitement des retraits (numéro de téléphone mobile money)
              </li>
            </ul>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">Données de connexion :</strong> adresse IP, type
                de navigateur, appareil utilisé
              </li>
              <li>
                <strong className="text-dark-200">Données d&apos;utilisation :</strong> tâches
                complétées, gains accumulés, historique de retraits
              </li>
              <li>
                <strong className="text-dark-200">Données de parrainage :</strong> code de
                parrainage, arbre de filleuls
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-disc list-inside">
              ...
              <li>
                Vous envoyer des communications liées au Service (vérification d&apos;e-mail,
                notifications)
              </li>
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">L&apos;exécution du contrat :</strong> les données
                sont nécessaires pour fournir le Service auquel vous avez souscrit
              </li>
              <li>
                <strong className="text-dark-200">L&apos;intérêt légitime :</strong> prévention de
                la fraude, amélioration du Service
              </li>
              <li>
                <strong className="text-dark-200">Le consentement :</strong> pour l&apos;envoi de
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">Prestataires de paiement :</strong> FedaPay, pour
                le traitement des transactions financières
              </li>
              <li>
                <strong className="text-dark-200">Hébergeurs :</strong> Vercel (frontend), Railway
                (API), Neon/Supabase (base de données)
              </li>
              <li>
                <strong className="text-dark-200">Authentification :</strong> Google, si vous
                choisissez de vous connecter via votre compte Google
              </li>
            </ul>
            <p className="mt-4">
              Ces prestataires n&apos;ont accès qu&apos;aux données strictement nécessaires à
              l&apos;exécution de leurs services et sont tenus de respecter la confidentialité de
              vos données.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">Données de compte :</strong> conservées tant que
                le compte est actif, puis supprimées sous 12 mois après la clôture
              </li>
              <li>
                <strong className="text-dark-200">Données financières :</strong> conservées pendant
                5 ans conformément aux obligations légales
              </li>
              <li>
                <strong className="text-dark-200">Données de connexion :</strong> conservées pendant
                12 mois
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-disc list-inside">
              <li>
                <strong className="text-dark-200">Droit d&apos;accès :</strong> obtenir une copie de
                vos données personnelles
              </li>
              <li>
                <strong className="text-dark-200">Droit de rectification :</strong> corriger des
                données inexactes ou incomplètes
              </li>
              <li>
                <strong className="text-dark-200">Droit à l&apos;effacement :</strong> demander la
                suppression de vos données
              </li>
              <li>
                <strong className="text-dark-200">Droit à la portabilité :</strong> recevoir vos
                données dans un format structuré
              </li>
              <li>
                <strong className="text-dark-200">Droit d&apos;opposition :</strong> vous opposer au
                traitement de vos données
              </li>
              <li>
                <strong className="text-dark-200">Droit à la limitation :</strong> demander la
          ...
          <section>
            ...
            <p>
              ...
              modification substantielle, vous serez informé par e-mail ou via une notification sur
              le Site.
            </p>
          </section>
