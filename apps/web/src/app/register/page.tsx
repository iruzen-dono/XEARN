  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 right-1/3 w-[420px] h-[420px] bg-accent-500/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/4 w-[340px] h-[340px] bg-primary-500/8 rounded-full blur-[100px]" />
      </div>
