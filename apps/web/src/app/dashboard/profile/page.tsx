                  ...
                  {[
                    {
                      ...
                      extra: user?.emailVerifiedAt ? (
                        <CheckCircle className="w-3.5 h-3.5 text-success-400 shrink-0 ml-auto" />
                      ) : null,
                    },
                    { icon: Phone, value: user?.phone || 'Non renseigné' },
                    {
                      ...
                      value: (
                        <>
                          <span className="text-xs text-dark-500 block">Code parrainage</span>
                    ...
                    {
                      icon: Calendar,
                      value: `Inscrit le ${user?.createdAt ? new Date(user.createdAt).toLocaleDateString('fr-FR') : '—'}`,
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 text-dark-400 p-2.5 rounded-xl bg-white/[0.02] border border-white/[0.04]"
                    >
