import { IsNumber, IsString, IsEnum, Min, Max, MaxLength, Matches, ValidateIf } from 'class-validator';
...
export class WithdrawDto {
  ...
  @Matches(/^\+?(228|229|225|233|234|237|221|223|226|227|235|241|242|243)\s?\d{7,9}$/, {
    message: 'Numéro de téléphone invalide. Format attendu : +228XXXXXXXX (Togo), +229XXXXXXXX (Bénin), +225XXXXXXXXXX (CI), etc.',
  })
  accountInfo: string;
}
